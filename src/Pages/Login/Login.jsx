...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-purple-300 bg-opacity-10  flex flex-col justify-center items-center">
            {
                error ? <p className="text-lg">{error}</p>  : <div className="min-h-screen  w-full flex flex-col justify-center items-center">

                {
                    loading ?  <span className="loading loading-bars loading-lg"></span> : <form onSubmit={handleLogin} className=" w-full lg:w-1/4 py-16 px-5 shadow-xl rounded-2xl gap-y-2  border bg-white   flex flex-col justify-center items-center" action="">
