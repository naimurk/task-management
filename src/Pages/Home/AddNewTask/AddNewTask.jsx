...
//  console.log(AllUsersData);
    ...
    return (
        <div className="min-h-screen w-full bg-purple-300 bg-opacity-10  flex flex-col justify-center items-center">
            ...
            {
                loding ? <span className="loading loading-bars loading-lg"></span> : <form onSubmit={handleSubmit} className=" lg:mt-12 w-full  lg:w-1/2 py-16 px-5 shadow-xl rounded-2xl gap-y-3 border bg-white   flex flex-col justify-center items-center" action="">
